...
Uwielbiam. Musiał stać się bazą tego bloga. Zapewnia przyjemniejszą pracę, łatwiejszy refactoring, oraz pozwala wrócić do pracy po dłuższym czasie i momentalnie odnaleźć się w projekcie.
...
Dzięki temu w bardzo łatwy sposób mogę umieszczać niestandardowe elementy w artykułach na blogu.
...
Dla przykładu, tak będzie wyglądać uproszczona wersja formularza, za pomocą którego możesz zapisać się na blogu do mojego newslettera (znajdziesz go na przykład pod tym artykułem):

> Niestety to nie jest już aktualne. Na blogu nie da się zapisać do newslettera. Ale technologia dalej jest super.
