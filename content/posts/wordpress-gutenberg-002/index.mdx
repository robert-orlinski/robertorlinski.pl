...
abstract: W drugiej częsci serii WordPress Gutenberg, zajmiemy się właściwościami, kategoriami oraz stylami CSS, własnych bloków Gutenberga 💥
isPublished: true
topics:
  - WordPress
...
![Nowa](https://nowywordpress.pl/wp-content/uploads/2020/10/nowa-kategoria-blokow-e1604170341921.png)## A teraz, zajmijmy się stylami CSS

A dokładnie plikami SCSS. Bo dzięki temu, że w [poprzedniej części serii](https://robertorlinski.pl/2020/11/16/wordpress-gutenberg-001/), zainstalowaliśmy paczkę `@wordpress/scripts`, teraz bardzo łatwo możemy automatycznie kompilować pliki SCSS, do CSS, podobnie jak robimy to z plikami JavaScriptu, zapisanymi w składni JSXa.
