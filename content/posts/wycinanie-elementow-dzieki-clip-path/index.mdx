...
abstract: Eksperymentalna właściwość clip-path pozwala na bardzo proste wycinanie elementów strony internetowej w CSS za pomocą czterech prostych wartości.
isPublished: true
topics:
  - Front-end
date: 28.09.2017
