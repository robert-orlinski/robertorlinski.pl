...
Możliwość pełnej edycji strony na WordPressie, a nie tylko stron i wpisów w obszarze, w ramach którego na to pozwolimy, to coś co od wielu, wielu miesięcy rozwijane jest przez zespół odpowiedzialny za Gutenberga, jak i przez pomagających im kontrybutorów.

W tej chwili idea ta rozwija się dynamicznie (na dzień gdy piszę te słowa - 27.12.2021) i cały czas sporo może się zmienić, ale z powodzeniem można się o niej uczyć.

Dobrym startem będzie:

> [Full Site Editing - overview](https://developer.wordpress.org/block-editor/getting-started/full-site-editing/)

## Wszelkie pozostałe, wbudowane w Gutenberga komponenty

Podczas kursu, poznaliśmy tylko kilka z nich, a w obecnej wersji Gutenberga (12.2.0) mamy ich kilkadziesiąt. I tak wiem - w jednej z poprzednich części serii podsyłałem Ci link do ich listy, ale w razie potrzeby robię to ponownie, abyś mógł lub mogła łatwo do tego wrócić.
...
A jeśli chodzi o Reduxa, to tutaj również polecam Ci dokumentację, jak i jeden film na YouTubie, który świetnie wprowadzi ten temat (dobrze jest obejrzeć go przed zajrzeniem do dokumentacji, bo zrozumienie Reduxa nie jest czymś, co zawsze przychodzi od ręki).
...
Jeśli chcesz dodać coś od siebie, to zawsze zapraszam Cię do sekcji komentarzy lub wysłania mi maila na [kontakt@robertorlinski.pl](mailto:kontakt@robertorlinski.pl) - chętnie dowiem się o Twoich wrażeniach po całej serii.
