...
> [KursJS.pl](http://kursjs.pl/) 
> [Dokumentacja MDN](https://developer.mozilla.org/en-US/docs/Web/javascript)
...
> [Dokumentacja Reduxa](https://redux.js.org/introduction/getting-started)
