...
Od tej chwili możemy skonfigurować go jak tylko chcemy. Ja skopiuję cały kod z pliku `index.php` i dodam podtytuł podobny do tego, co w pliku [`archive.php`](https://robertorlinski.pl/2017/11/27/archiwa/), tak że całość będzie prezentować się w ten oto sposób:
